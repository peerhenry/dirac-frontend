...
var _MessageFactory = __webpack_require__(41);

var _MessageFactory2 = _interopRequireDefault(_MessageFactory);

var _Dirac = __webpack_require__(37);

var _Dirac2 = _interopRequireDefault(_Dirac);

var _MessageAnalyzer = __webpack_require__(40);
...
var Dirac = function () {
  ...
  _createClass(Dirac, [{
    ...
    value: function respondToSentence(response, message) {
      switch (message.words[0]) {
        case "what":
          _DiracQuestionResponder2.default.what(response, message);
          break;
        case "why":
          _DiracQuestionResponder2.default.why(response, message);
          break;
        case "where":
          _DiracQuestionResponder2.default.where(response, message);
          break;
        case "when":
          _DiracQuestionResponder2.default.when(response, message);
          break;
        case "how":
          _DiracQuestionResponder2.default.how(response, message);
          break;
        case "who":
          _DiracQuestionResponder2.default.who(response, message);
          break;
        case "i":
          _DiracStatementResponder2.default.I(response, message);
          break;
        case "my":
          _DiracStatementResponder2.default.my(response, message);
          break;
      }
    }
  }, {
    key: "respondToTwoWords",
    value: function respondToTwoWords(response, message) {
      response.content = "I'm sorry, I don't respond to sentences of two words.";
    }
  }, {
    key: "respondToOneWord",
    value: function respondToOneWord(response, word) {
...
var DiracQuestionResponder = function () {
  ...
  _createClass(DiracQuestionResponder, [{
    ...
    // private
    value: function callServer(response, message) {
    ...
    key: "what",
    value: function what(response, message) {
    ...
    key: "who",
    value: function who(response, message) {
      var formattedWords = message.words;
      response.content = "I don't know.";
      switch (formattedWords[1]) {
        case "are":
          if (formattedWords.length === 3 && formattedWords[2] === "you") response.content = "I am Dirac.";else {
            this.callServer(response, message);
          }
          break;
        case "s":
    ...
    key: "why",
    value: function why(response, message) {
      var formattedWords = message.words;
      response.content = "I don't know.";
    }
  }, {
    key: "when",
    value: function when(response, message) {
      var formattedWords = message.words;
      response.content = "I don't know.";
    }
  }, {
    key: "where",
    value: function where(response, message) {
      var formattedWords = message.words;
      response.content = "I don't know.";
    }
  }, {
    key: "how",
    value: function how(response, message) {
      var formattedWords = message.words;
      response.content = "I don't know.";
      switch (formattedWords[1]) {
        case "are":
...
var DiracStatementResponder = function () {
  ...
  _createClass(DiracStatementResponder, [{
    key: "I",
    value: function I(response, message) {
      response.content = "OK";
    }
  }, {
    key: "my",
    value: function my(response, message) {
      response.content = "OK";
    }
  }]);
...
var MessageAnalyzer = function () {
  ...
  _createClass(MessageAnalyzer, [{
    ...
    value: function analyze(input) {
      var words = input.toLowerCase().split(/[ .,'"<>?.!;:]/g).filter(function (n) {
