...
var MessageFactory = function () {
  ...
  _createClass(MessageFactory, [{
    key: 'createMessage',
    value: function createMessage(line) {
      return {
        content: line,
        user: 'Default'
      };
    ...
    key: 'createDiracMessage',
    value: function createDiracMessage(line) {
      return {
        content: line,
        user: 'Dirac'
      };
...
var _MessageFactory = __webpack_require__(4);

var _MessageFactory2 = _interopRequireDefault(_MessageFactory);

var _Dirac = __webpack_require__(10);
...
var App = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function keyPress(e) {
      ...
      if (charCode == '13') {
        var msg = _MessageFactory2.default.createMessage(e.target.value);
        this.props.store.addMessage(msg);
        setTimeout(function () {
          var response = _Dirac2.default.respond(msg);
...
var _DiracQuestionResponder = __webpack_require__(11);
...
var Dirac = function () {
  ...
  _createClass(Dirac, [{
    ...
    value: function respondToSentence(message) {
      var words = _MessageAnalyzer2.default.analyze(message);
      var response = "I didn't understand the sentence.";
      switch (words[0]) {
        case "what":
          response = _DiracQuestionResponder2.default.what(message, words);
          break;
        case "why":
          response = _DiracQuestionResponder2.default.why(message, words);
          break;
        case "where":
          response = _DiracQuestionResponder2.default.where(message, words);
          break;
        case "when":
          response = _DiracQuestionResponder2.default.when(message, words);
          break;
        case "how":
          response = _DiracQuestionResponder2.default.how(message, words);
          break;
        case "who":
          response = _DiracQuestionResponder2.default.who(message, words);
          break;
      }
      return response;
    }
    ...
    value: function respondToTwoWords(message) {
      var words = message.content.split(' ');
      var response = "I'm sorry, I don't respond to sentences of two words.";
      return response;
    }
  }, {
    key: "respondToOneWord",
    value: function respondToOneWord(word) {
      var response = "I don't understand that word.";
      switch (word.toLowerCase()) {
        ...
        case 'sup':
          ...
          break;
        case 'time':
          response = _TimeFormatter2.default.getTime();
          break;
        case 'date':
          response = _TimeFormatter2.default.getDate();
          break;
      }
      return response;
    }
    ...
    value: function respond(message) {
      ...
      return _MessageFactory2.default.createDiracMessage(response);
    }
  }]);
...
var DiracQuestionResponder = function () {
  ...
  _createClass(DiracQuestionResponder, [{
    key: "itMatches",
    value: function itMatches(words, question) {
    ...
    key: "what",
    value: function what(message, formattedWords) {
    ...
    key: "who",
    value: function who(message, formattedWords) {
      var response = "I don't know.";
      switch (formattedWords[1]) {
        case "are":
    ...
    key: "why",
    value: function why(message, formattedWords) {
      var response = "I don't know.";
      return response;
    }
  }, {
    key: "when",
    value: function when(message, formattedWords) {
      var response = "I don't know.";
      return response;
    }
  }, {
    key: "where",
    value: function where(message, formattedWords) {
      var response = "I don't know.";
      return response;
    }
  }, {
    key: "how",
    value: function how(message, formattedWords) {
...
var MessageAnalyzer = function () {
  ...
  _createClass(MessageAnalyzer, [{
    ...
    value: function analyze(message) {
      var words = message.content.toLowerCase().split(/[ .,'"<>?.!;:]/g).filter(function (n) {
...
var _DiracStore = __webpack_require__(6);
